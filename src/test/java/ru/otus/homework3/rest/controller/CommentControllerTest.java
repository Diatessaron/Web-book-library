...
class CommentControllerTest {
    ...
    void testSaveByStatus() throws Exception {
        when(commentService.saveComment("Book", "Comment"))
                .thenReturn("Comment created");
    ...
    void testEditByStatus() throws Exception {
        ...
        mockMvc.perform(put("/api/comments/Comment")
    ...
    void testDeleteByContentByStatus() throws Exception {
        ...
        mockMvc.perform(delete("/api/comments/Comment"))
                .andExpect(status().isOk());
    }
}
